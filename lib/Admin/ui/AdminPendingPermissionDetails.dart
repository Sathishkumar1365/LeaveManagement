...
class AdminPendingPermissionDetails extends StatefulWidget {
  final PermissionForm permissionForm;
  AdminPendingPermissionDetails({Key? key, required this.permissionForm}) : super(key: key);

  @override
  State<AdminPendingPermissionDetails> createState() => _AdminPendingPermissionDetailsState();
}

class _AdminPendingPermissionDetailsState extends State<AdminPendingPermissionDetails> {
  @override
