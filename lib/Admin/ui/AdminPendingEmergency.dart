...
import 'AdminPendingEmergencyDetails.dart';

class AdminPendingEmergency extends StatefulWidget {
  const AdminPendingEmergency({Key? key}) : super(key: key);

  @override
  State<AdminPendingEmergency> createState() => _AdminPendingEmergencyState();
}

class _AdminPendingEmergencyState extends State<AdminPendingEmergency> {
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("emergencyleave").orderBy("timestamp", descending: true).snapshots(),
        builder: (BuildContext context,snapshot){
          if(snapshot.hasData){
            ...
            snapshot.data!.docs.forEach((documentSnapshot) {
              ...
              final leaveDate = DateTime.fromMillisecondsSinceEpoch(timestamp.millisecondsSinceEpoch);
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text("Today's Leaves", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),),
                            ),
                            ListView.builder(
                                ...
                                itemBuilder: (BuildContext context,int index){
                                  ...
                                  return InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>AdminPendingEmergencyDetails(emergencyForm:
                                      EmergencyForm(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      Text(documentSnapshot["name"],style: GoogleFonts.ubuntu(color: Colors.black),),
                                                      SizedBox(height: 10,),
                      ...
                      Container(
                        child: Column(
                          ...
                          children: [
                            Container(
                              padding: EdgeInsets.all(10),
                              child: Text("Previous Leaves", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),),
                            ),
                            ListView.builder(
                      ...
                      Container(child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            height: 150,
                            width: double.infinity,
                            child: Center(child: Text("No Records Found",style: TextStyle(color: Colors.white),),),
                          )
          ...
          return Center(child: Text('No records',style: TextStyle(color: Colors.white),),);
        },
      ),
    );
  }
