...
class AdminPendingEmergencyDetails extends StatefulWidget {
  final EmergencyForm emergencyForm;
  AdminPendingEmergencyDetails({Key? key, required this.emergencyForm}) : super(key: key);

  @override
  State<AdminPendingEmergencyDetails> createState() => _AdminPendingEmergencyDetailsState();
}

class _AdminPendingEmergencyDetailsState extends State<AdminPendingEmergencyDetails> {
  @override
