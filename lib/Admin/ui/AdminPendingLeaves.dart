...
import 'AdminPendingLeaveDetails.dart';

class AdminPendingLeaves extends StatefulWidget {
  const AdminPendingLeaves({Key? key}) : super(key: key);

  @override
  State<AdminPendingLeaves> createState() => _AdminPendingLeavesState();
}

class _AdminPendingLeavesState extends State<AdminPendingLeaves> {
                                ...
                                onTap: () {
                                  Navigator.push(context,
                                      MaterialPageRoute(builder: (context) =>
                                          AdminPendingLeaveDetails(leaveForm:
                                          LeaveForm(
