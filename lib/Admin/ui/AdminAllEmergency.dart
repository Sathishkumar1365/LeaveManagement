...
class AdminAllEmergency extends StatefulWidget {
  const AdminAllEmergency({Key? key}) : super(key: key);

  @override
  State<AdminAllEmergency> createState() => _AdminAllEmergencyState();
}

class _AdminAllEmergencyState extends State<AdminAllEmergency> {
  @override
  Widget build(BuildContext context) {

    return SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("allemergencyleaves").orderBy("timestamp", descending: true).snapshots(),
