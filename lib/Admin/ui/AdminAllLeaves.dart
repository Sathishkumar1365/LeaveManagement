...
class AdminAllLeaves extends StatefulWidget {
  const AdminAllLeaves({Key? key}) : super(key: key);

  @override
  State<AdminAllLeaves> createState() => _AdminAllLeavesState();
}
...
class _AdminAllLeavesState extends State<AdminAllLeaves> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("allleaves").orderBy("timestamp", descending: true).snapshots(),
                          ...
                          children: [
                            ...
                            ListView.builder(
                                ...
                                itemBuilder: (BuildContext context,int index){
                                  ...
                                  return InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>AdminAllLeaveDetials(leaveForm:
                                      LeaveForm(
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Container(
                                                  ...
                                                  child: Center(
                                                      child: Text(documentSnapshot["status"],style: GoogleFonts.ubuntu(color: documentSnapshot["status"] == "approved" ? Colors.green : Colors.red)))),
                                              Text((DateFormat('dd-MM-yyyy hh:mm').format((documentSnapshot["timestamp"] as Timestamp).toDate())),style: GoogleFonts.ubuntu(color: Colors.black),),
                                            ],
                                          ),
                                        ],
                                      ),
