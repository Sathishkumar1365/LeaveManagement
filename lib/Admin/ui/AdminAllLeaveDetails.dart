...
class AdminAllLeaveDetials extends StatefulWidget {
  final LeaveForm leaveForm;
  const AdminAllLeaveDetials({Key? key, required this.leaveForm}) : super(key: key);

  @override
  State<AdminAllLeaveDetials> createState() => _AdminAllLeaveDetialsState();
}

class _AdminAllLeaveDetialsState extends State<AdminAllLeaveDetials> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
                ...
                child: Center(
                    child: Text(widget.leaveForm.status!,style: GoogleFonts.ubuntu(color: widget.leaveForm.status == "Approved" ? Colors.green : Colors.red)))),
            SizedBox(height: 20,),
            Center(
              child: Container(
