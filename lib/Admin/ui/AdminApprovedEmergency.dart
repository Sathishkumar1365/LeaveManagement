...
import 'AdminAllEmergencyDetails.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
class AdminApprovedEmergency extends StatefulWidget {
  const AdminApprovedEmergency({Key? key}) : super(key: key);
  @override
  State<AdminApprovedEmergency> createState() => _AdminApprovedEmergencyState();
}

class _AdminApprovedEmergencyState extends State<AdminApprovedEmergency> {
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("approvedemergencyleave").orderBy("timestamp", descending: true).snapshots(),
                          ...
                          children: [
                            ...
                            ListView.builder(
                                ...
                                itemBuilder: (BuildContext context,int index){
                                  ...
                                  return InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>AdminAllEmergencyDetails(emergencyForm:
                                      EmergencyForm(
