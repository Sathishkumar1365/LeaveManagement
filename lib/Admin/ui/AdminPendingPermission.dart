...
import 'AdminPendingPermissionDetails.dart';

class AdminPendingPermission extends StatefulWidget {
  const AdminPendingPermission({Key? key}) : super(key: key);

  @override
  State<AdminPendingPermission> createState() => _AdminPendingPermissionState();
}

class _AdminPendingPermissionState extends State<AdminPendingPermission> {
