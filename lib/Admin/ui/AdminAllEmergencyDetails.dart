...
class AdminAllEmergencyDetails extends StatefulWidget {
  final EmergencyForm emergencyForm;
  AdminAllEmergencyDetails({Key? key, required this.emergencyForm}) : super(key: key);

  @override
  State<AdminAllEmergencyDetails> createState() => _AdminAllEmergencyDetailsState();
}

class _AdminAllEmergencyDetailsState extends State<AdminAllEmergencyDetails> {
  @override
