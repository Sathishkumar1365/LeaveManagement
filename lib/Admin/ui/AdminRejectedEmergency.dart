...
class AdminRejectedEmergency extends StatefulWidget {
  const AdminRejectedEmergency({Key? key}) : super(key: key);

  @override
  State<AdminRejectedEmergency> createState() => _AdminRejectedEmergencyState();
}

class _AdminRejectedEmergencyState extends State<AdminRejectedEmergency> {
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("rejectedemergencyleave").orderBy("timestamp", descending: true).snapshots(),
