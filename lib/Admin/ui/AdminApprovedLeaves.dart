...
class AdminApprovedLeaves extends StatefulWidget {
  const AdminApprovedLeaves({Key? key}) : super(key: key);

  @override
  State<AdminApprovedLeaves> createState() => _AdminApprovedLeavesState();
}

class _AdminApprovedLeavesState extends State<AdminApprovedLeaves> {
  final FirebaseAuth auth = FirebaseAuth.instance;
  @override
  Widget build(BuildContext context) {
    return  SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("approvedleave").orderBy("timestamp", descending: true).snapshots(),
