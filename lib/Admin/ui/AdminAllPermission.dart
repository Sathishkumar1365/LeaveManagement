...
class AdminAllPermission extends StatefulWidget {
  const AdminAllPermission({Key? key}) : super(key: key);

  @override
  State<AdminAllPermission> createState() => _AdminAllPermissionState();
}

class _AdminAllPermissionState extends State<AdminAllPermission> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("allpermissions").orderBy("timestamp", descending: true).snapshots(),
