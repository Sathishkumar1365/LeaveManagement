...
class AdminRejectedPermission extends StatefulWidget {
  const AdminRejectedPermission({Key? key}) : super(key: key);

  @override
  State<AdminRejectedPermission> createState() => _AdminRejectedPermissionState();
}

class _AdminRejectedPermissionState extends State<AdminRejectedPermission> {
  final FirebaseAuth auth = FirebaseAuth.instance;
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("rejectedpermission").orderBy("timestamp", descending: true).snapshots(),
