...
class ApprovedEmergencyLeaves extends StatefulWidget {
  const ApprovedEmergencyLeaves({Key? key}) : super(key: key);

  @override
  State<ApprovedEmergencyLeaves> createState() => _ApprovedEmergencyLeavesState();
}

class _ApprovedEmergencyLeavesState extends State<ApprovedEmergencyLeaves> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text('Approved emergency Leaves',style: GoogleFonts.ubuntu(color: Colors.black),),
            leading: Padding(
        ...
        body:StreamBuilder(
          stream: FirebaseFirestore.instance.collection("approvedemergencyleave").where('emp_id',isEqualTo: user!.uid).orderBy("timestamp", descending: true).snapshots(),
