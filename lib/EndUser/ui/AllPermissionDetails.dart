...
class AllPermissionDetails extends StatefulWidget {
  final PermissionForm permissionForm;
  const AllPermissionDetails({Key? key, required this.permissionForm}) : super(key: key);

  @override
  State<AllPermissionDetails> createState() => _AllPermissionDetailsState();
}

class _AllPermissionDetailsState extends State<AllPermissionDetails> {
  @override
