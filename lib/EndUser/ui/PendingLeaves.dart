...
import 'PendingLeaveDetails.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Pending Leaves',style: GoogleFonts.ubuntu(color: Colors.black),),
          leading: Padding(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("leave").where('emp_id',isEqualTo: user!.uid).orderBy("timestamp", descending: true).snapshots(),
            ...
            return Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context,int index){
                    ...
                    return InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>PendingLeaveDetails(leave:
                        LeaveForm(
