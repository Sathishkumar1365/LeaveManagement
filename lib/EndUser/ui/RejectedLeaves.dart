  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
          ...
          title: Text('Rejected Leaves',style: GoogleFonts.ubuntu(color: Colors.black),),
          leading: Padding(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("rejectedleaves").where('emp_id',isEqualTo: user!.uid).orderBy("timestamp", descending: true).snapshots(),
