...
class AllLeaveDetails extends StatefulWidget {
  ...
  const AllLeaveDetails({Key? key, this.leave}) : super(key: key);
          ...
          children: [
            ...
            Container(
              width: 100,
                ...
                child: Center(
                    child: Text(widget.leave!.status!,style: GoogleFonts.ubuntu(color: widget.leave!.status == "Approved" ? Colors.green : Colors.red)))),
            SizedBox(height: 20,),
            Center(
              child: Container(
