...
class ApprovedPermission extends StatefulWidget {
  const ApprovedPermission({Key? key}) : super(key: key);

  @override
  State<ApprovedPermission> createState() => _ApprovedPermissionState();
}

class _ApprovedPermissionState extends State<ApprovedPermission> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text('Approved Permission',style: GoogleFonts.ubuntu(color: Colors.black),),
            leading: Padding(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("approvedpermission").where('emp_id',isEqualTo: user!.uid).orderBy("timestamp", descending: true).snapshots(),
