...
class RejectedPermission extends StatefulWidget {
  const RejectedPermission({Key? key}) : super(key: key);

  @override
  State<RejectedPermission> createState() => _RejectedPermissionState();
}

class _RejectedPermissionState extends State<RejectedPermission> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text('Rejected Permission',style: GoogleFonts.ubuntu(color: Colors.black),),
            leading: Padding(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("rejectedpermission").where('emp_id',isEqualTo: user!.uid).orderBy("timestamp", descending: true).snapshots(),
