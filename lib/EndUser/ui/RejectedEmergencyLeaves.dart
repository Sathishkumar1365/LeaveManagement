...
class RejectedEmergencyLeaves extends StatefulWidget {
  const RejectedEmergencyLeaves({Key? key}) : super(key: key);

  @override
  State<RejectedEmergencyLeaves> createState() => _RejectedEmergencyLeavesState();
}

class _RejectedEmergencyLeavesState extends State<RejectedEmergencyLeaves> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text('Rejected emergency Leaves',style: GoogleFonts.ubuntu(color: Colors.black),),
            leading: Padding(
        ...
        body:StreamBuilder(
          stream: FirebaseFirestore.instance.collection("rejectedemergencyleave").where('emp_id',isEqualTo: user!.uid).orderBy("timestamp", descending: true).snapshots(),
